  ...
  <div id="wrap">
	...
	<!-- 메인 -->
  	...
  	<div class="adminReservation_wrap2">
        <div class="adminReservation_title">
            <strong><a href="./AdminReservationList.rez">관리자 예약 조회 리스트</a></strong>
				...
				<div class="n_search" border="1" width="90%" >
						...
						<div class="n_search" border="1" width="90%">
							<div align="right">
							<form action="./SearchList.rez">
								<select name="type" class="form-controller">
		...
		<c:forEach var="rezDTO" items="${searchList }">
			  <div>
		...
		<br>
			...
			<c:if test="${startPage > pageBlock }">
				<a href="./SearchList.rez?pageNum=${startPage-pageBlock }&type=${type }&keyword=${keyword }">[이전]</a>
			</c:if>
						<!-- 페이지 번호(1,2,3...) -->
					<c:forEach var="i" begin="${startPage }" end="${endPage }"
						...
						<a href="./SearchList.rez?pageNum=${i }&type=${type }&keyword=${keyword }">${i }</a>
						</span>
						</li>
			...
			<c:if test="${endPage < pageCount }">
				<a href="./SearchList.rez?pageNum=${startPage+pageBlock }&type=${type }&keyword=${keyword }">[다음]</a>
			</c:if>
					</ul>
